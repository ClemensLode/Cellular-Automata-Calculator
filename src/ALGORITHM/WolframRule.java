...
public class WolframRule {
     ...
     */
    public static BigInteger getWolframRuleNumber(final int[] function, final int cell_states) {
    ...
    /**
     * Calculates the upper boundary of all wolfram rule numbers with the current settings
     * @param function_size size of function array (number of different values for the neighborhood)
     * @param cell_states number of cell states
     * @return upper boundary of all wolfram rule numbers
     */
    public static BigInteger getMaxWolframRuleNumber(final int function_size, final int cell_states) {
