...
public class Misc {
	 ...
	 */
	public static void next_array_permutation(final int n[]) {
		int i = n.length - 1;
	 ...
	 *            array to be permutated
	 */
	public static void next_array_permutation_ignore_equals(final int n[]) {
	 ...
	 * 
	 * @param function
	 *            current function as an array, starting with an ascending array
	 * @return next function permutation
	 */
	public static boolean next_function_permutation(final int function[]) {
	...
	/**
	 * Determines the maximal distance of entries within an array (max - min
	 * value)
	 * 
	 * @param array
	 *            array of which we want the maximal distance
	 * @return maximal distance
	 */
	public static int get_max_distance(final int array[]) {
	 ...
	 * 
	 * @param array
	 *            array of which we want the largest value
	 * @return largest value of the array
	 */
	public static int get_max_value(final int array[]) {
	 ...
	 * 
	 * @param array
	 *            of which we want the smallest value
	 * @return smallest value of the array
	 */
	public static int get_min_value(final int array[]) {
	...
	/**
	 * Calculates the next state of a cell using the current neighborhood of the
	 * cell and the cell function
	 * 
	 * @param neighbors
	 *            neighborhood values for the function
	 * @param function
	 *            cellular automata function that calculates the next value
	 *            using the neighborhod values
	 * @param cell_states
	 *            number of cell states
	 * @return the function value of the appropriate index
	 */
	public static int getNeighborhoodFunction(final int[] neighbors,
			final int[] function, final int cell_states) {
